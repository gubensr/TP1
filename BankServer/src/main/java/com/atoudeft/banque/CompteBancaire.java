...
public abstract class CompteBancaire implements Serializable {
    ...
    private final PileChainee historique;
    ...
    public void effectuerTransfer(double montant, String numeroCompteDestinataire) {
    ...
    public void effectuerPaiementFacture(double montant, String numeroFacture, String description) {
